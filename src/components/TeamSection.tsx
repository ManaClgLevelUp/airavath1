        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-[32px]">
          {members.map((member, i) => (
            <motion.div
              ...
              className="group flex flex-col items-center text-center rounded-[12px] border border-border bg-card p-[32px] min-h-[340px] hover:-translate-y-2 hover:shadow-[0_0_24px_hsl(189_100%_50%/0.15)] hover:border-primary/30 transition-all duration-300"
            >
              <div
